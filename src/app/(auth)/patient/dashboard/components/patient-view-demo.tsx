      ...
      <Tabs defaultValue="record" className="w-full">
          ...
          <Card className="bg-muted/30">
            <CardContent className="pt-4">
              <p className="text-xs text-muted-foreground flex items-center gap-2">
                ...
                Last updated: {new Date(aggregatedData.last_updated).toLocaleDateString('en-IN', { 
                  day: 'numeric',
                  month: 'short',
                  year: 'numeric'
                })}
        ...
        <TabsContent value="consent" className="mt-4 space-y-4">
          ...
          <Card className="border-primary/20">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-sm">
                Control healthcare provider access to your records
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Alert>
            ...
            <AlertDescription className="text-sm">
              <strong>Important:</strong> Emergency access to critical info remains available
            </AlertDescription>
          </Alert>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Healthcare providers won't access your records. Emergency info stays available.
                </AlertDialogDescription>
              </AlertDialogHeader>
        ...
        <TabsContent value="emergency" className="mt-4 space-y-4">
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription className="text-sm">
              <strong>Emergency Policy:</strong> Critical info accessible in life-threatening situations
            </AlertDescription>
          </Alert>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <EmergencyCard 
              title="Blood Group" 
              icon={Activity} 
              description="Critical for transfusions"
              bgColor="border-red-200 bg-red-50/50 dark:bg-red-950/10"
            ...
            <EmergencyCard 
              ...
              bgColor="border-orange-200 bg-orange-50/50 dark:bg-orange-950/10"
            ...
            <EmergencyCard 
              ...
              icon={Heart} 
              description="Ongoing conditions"
              bgColor="border-blue-200 bg-blue-50/50 dark:bg-blue-950/10"
            ...
            <EmergencyCard 
              ...
              bgColor="border-purple-200 bg-purple-50/50 dark:bg-purple-950/10"
