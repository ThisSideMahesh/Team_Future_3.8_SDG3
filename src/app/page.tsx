          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground max-w-prose">
                SwasthyaSetu is a unified platform connecting patients and healthcare providers for a seamless healthcare experience. Access your aggregated health records from multiple providers, all in one place.
              </p>
                    ...
                    <Card className="text-left">
                        <CardHeader>
                            <CardTitle className="font-headline flex items-center gap-2">
                                <Stethoscope className="text-primary"/> For Healthcare Providers
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
